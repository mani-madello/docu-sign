import { _ as Ma } from "./SignEncryption-ComA92oE.js";
import "../assets/index-CCJbelsI.js";
import "./vendor-2z0F1iGp.js";
import "./@component-hook/pdf-canvas-DuZ37e5K.js";
import "./SignPassword.vue_vue_type_script_setup_true_lang-BS2uRloV.js";
...
function Z() {
  ...
  return lr = n2(typeof globalThis == "object" && globalThis) || n2(typeof window == "object" && window) || n2(typeof self == "object" && self) || n2(typeof qa == "object" && qa) || n2(typeof lr == "object" && lr) || /* @__PURE__ */ function() {
    return this;
...
function ef() {
  ...
  du = 1;
  for (var n2 = Jh(), e = typeof window > "u" ? qa : window, r = ["moz", "webkit"], t = "AnimationFrame", i = e["request" + t], a = e["cancel" + t] || e["cancelRequest" + t], s = 0; !i && s < r.length; s++) i = e[r[s] + "Request" + t], a = e[r[s] + "Cancel" + t] || e[r[s] + "CancelRequest" + t];
  if (!i || !a) {
...
var Fc = Object.freeze({ __proto__: null, offscreen: Ef, node: Rf });
function sr(n2) {
