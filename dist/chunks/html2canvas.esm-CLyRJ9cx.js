...
var oi = { name: "word-break", initialValue: "normal", prefix: false, type: 2, parse: function(e, A) {
  ...
  function e(A, t) {
    this.context = A, this.textNodes = [], this.elements = [], this.flags = 0, Jr(t, 3), this.styles = new Ki(A, window.getComputedStyle(t, null)), Yr(t) && (this.styles.animationDuration.some(function(r) {
      return r > 0;
...
var qi = 1, Ur = 2, Fr = 3, Tt = 4, St = 5, ji = 7, Ot = 8, hr = 9, dr = 10, Mt = 11, Gt = 12, Rt = 13, Vt = 14, Er = 15, zi = function(e) {
  ...
  return e.prototype.toIFrame = function(A, t) {
    ...
    if (Jr(A, 2), ZB(A)) return this.createCanvasClone(A);
  ...
  return A.prototype.applyEffects = function(t) {
    ...
    return P(this, void 0, void 0, function() {
      return _(this, function(r) {
        switch (r.label) {
          case 0:
            return G(t.container.flags, 16), t.container.styles.isVisible() ? [4, this.renderNodeBackgroundAndBorders(t)] : [3, 3];
          case 1:
    ...
    return P(this, void 0, void 0, function() {
      ...
      return _(this, function(F) {
        switch (F.label) {
          case 0:
            return G(t.element.container.flags, 16), [4, this.renderNodeBackgroundAndBorders(t.element)];
          case 1:
