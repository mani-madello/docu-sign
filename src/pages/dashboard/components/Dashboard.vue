  ...
  <div class="space-y-6 min-h-screen">
    ...
    <section class="mb-6 flex items-center justify-between">
      <div class="flex items-center justify-start">
        <h1 class="text-3xl leading-tight">Welcome back, {{ user.name }}</h1>
      </div>
    </section>
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          <div class="justify-between items-center flex mb-3">
            ...
            <div class="flex items-center justify-center">
              <button
                class="inline-flex justify-center items-center whitespace-nowrap focus:outline-hidden transition-colors focus:ring-3 duration-150 border cursor-pointer rounded-sm border-gray-100 dark:border-slate-800 ring-gray-200 dark:ring-gray-500 bg-gray-100 text-black dark:bg-slate-800 dark:text-white hover:bg-gray-200 dark:hover:bg-slate-700 p-1"
                type="button"
                icon-w="w-4"
                icon-h="h-4"
              >
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Documents</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>512</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Trash</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>58</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Sent</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>212</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Signed</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>212</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Archived</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>146</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
              <span class="inline-flex justify-center items-center h-16 text-blue-500"
      ...
      <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          ...
          <div class="justify-between items-center flex">
            <div class="flex items-center justify-center">
              <div>
                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Overall</h3>
                <h1 class="text-3xl leading-tight font-semibold"><div>68%</div></h1>
              </div>
            </div>
            <div class="flex items-center justify-center">
              <span class="inline-flex justify-center items-center h-16 text-red-500"
                ...
                <div class="justify-start items-center block md:flex">
                  ...
                  <div class="flex items-center justify-center">
                    <div class="text-center md:text-left overflow-hidden">
                      ...
                      <p class="text-gray-500 dark:text-slate-400">Mar 3, 2025 @ percy64</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="justify-start items-center block md:flex">
                  ...
                  <div class="flex items-center justify-center">
                    <div class="text-center md:text-left overflow-hidden">
                      ...
                      <p class="text-gray-500 dark:text-slate-400">Dec 1, 2025 @ dare.concepcion</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="justify-start items-center block md:flex">
                  ...
                  <div class="flex items-center justify-center">
                    <div class="text-center md:text-left overflow-hidden">
                      ...
                      <p class="text-gray-500 dark:text-slate-400">May 18, 2025 @ geovanni.kessler</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="justify-start items-center block md:flex">
                  ...
                  <div class="flex items-center justify-center">
                    <div class="text-center md:text-left overflow-hidden">
                      ...
                      <p class="text-gray-500 dark:text-slate-400">May 4, 2025 @ macejkovic.dashawn</p>
                    </div>
                  </div>
                </div>
              </div>
