    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
      ...
      <nav>
        <ol class="flex items-center gap-1.5">
          ...
          <li class="text-sm text-gray-800 dark:text-white/90">User Profile</li>
        </ol>
      </nav>
    </div>
            ...
            <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
              ...
              <div class="order-3 xl:order-2">
                ...
                <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                  ...
                  <p class="text-sm text-gray-500 dark:text-gray-400">Tienen, Belgium</p>
                </div>
              </div>
              <div class="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
                <button
                  class="inline-flex justify-center items-center whitespace-nowrap focus:outline-hidden transition-colors focus:ring-3 duration-150 border cursor-pointer rounded-sm border-gray-100 dark:border-slate-800 ring-gray-200 dark:ring-gray-500 bg-gray-100 text-black dark:bg-slate-800 dark:text-white hover:bg-gray-200 dark:hover:bg-slate-700 p-1 mr-3 last:mr-0 mb-3"
                  type="button"
                >
            ...
            <div>
              ...
              <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                <div>
                  ...
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">Madhavan</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Last Name</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">Elango</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Email address</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">hello@madello.com</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Phone</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">+32 363 398 46</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Bio</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">Founder & CEO</p>
                </div>
              </div>
            </div>
            <button
            ...
            <div>
              ...
              <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                <div>
                  ...
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">Belgium</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">City/State</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">Tienen, Belgium</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Postal Code</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">4120</p>
                </div>
                <div>
                  <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">TAX ID</p>
                  <p class="text-sm font-medium text-gray-800 dark:text-white/90">BE 1060.234.56</p>
                </div>
              </div>
            </div>
            <button
