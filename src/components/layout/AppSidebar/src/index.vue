...
<template>
  <aside
    id="aside"
    class="lg:py-2 lg:pl-2 lg:pr-2 w-60"
  >
            ...
            <a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"
              ><span class="inline-flex justify-center items-center w-16 h-6 flex-none"
                ...
                >
                  ...
                  /></svg></span
              ><span class="grow text-ellipsis line-clamp-1 pr-12">Sign File</span
              ><!----></a
            ><!---->
          </li>
          <li
            ...
            <a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"
              ><span class="inline-flex justify-center items-center w-16 h-6 flex-none"
                ...
                >
                  ...
                  /></svg></span
              ><span class="grow text-ellipsis line-clamp-1 pr-12">Sent Files</span
              ><!----></a
            ><!---->
          </li>
          <li
            ...
            <a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"
              ><span class="inline-flex justify-center items-center w-16 h-6 flex-none"
                ...
                >
                  ...
                  /></svg></span
              ><span class="grow text-ellipsis line-clamp-1 pr-12">Archived Files</span
              ><!----></a
            ><!---->
          </li>
          <li
            ...
            <a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"
              ><span class="inline-flex justify-center items-center w-16 h-6 flex-none"
                ...
                >
                  ...
                  /></svg></span
              ><span class="grow text-ellipsis line-clamp-1 pr-12">Trash Files</span
              ><!----></a
            ><!---->
          </li>
          <li
            ...
            <a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"
              ><span class="inline-flex justify-center items-center w-16 h-6 flex-none"
                ...
                >
                  ...
                  /></svg></span
              ><span class="grow text-ellipsis line-clamp-1 pr-12">Settings</span
              ><!----></a
            ><!---->
          </li>
        </ul>
